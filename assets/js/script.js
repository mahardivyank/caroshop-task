...
let scrollPosition = 0;
const productWidth = document.querySelector('.product-container').offsetWidth + 20; // Width of each product container

nextBtn3.addEventListener('click', () => {
    scrollPosition -= productWidth; // Scroll one product at a time
    productSlider.style.transform = `translateX(${scrollPosition}px)`;
});
